...
package net.waloyodev.speedbrowser5g.view

import net.waloyodev.speedbrowser5g.constant.DESKTOP_USER_AGENT
import net.waloyodev.speedbrowser5g.constant.MOBILE_USER_AGENT
...
import net.waloyodev.speedbrowser5g.network.NetworkConnectivityModel
...
import net.waloyodev.speedbrowser5g.utils.UrlUtils
import net.waloyodev.speedbrowser5g.utils.Utils
...
/**
 * [LightningView] acts as a tab for the waloyodev, handling WebView creation and handling logic, as
...
class LightningView(
    ...
    /**
     * Sets whether this tab was the result of a new intent sent to the waloyodev.
     */
    ...
    /**
     * This method gets the additional headers that should be added with each request the waloyodev
     * makes.
     *
    ...
    /**
     * This method loads the homepage for the waloyodev. Either it loads the URL stored as the
