package net.waloyodev.speedbrowser5g.browser.fragment

import net.waloyodev.speedbrowser5g.R
import net.waloyodev.speedbrowser5g.adblock.allowlist.AllowListModel
import net.waloyodev.speedbrowser5g.animation.AnimationUtils
import net.waloyodev.speedbrowser5g.browser.BookmarksView
import net.waloyodev.speedbrowser5g.browser.TabsManager
import net.waloyodev.speedbrowser5g.browser.bookmark.BookmarkUiModel
...
import net.waloyodev.speedbrowser5g.di.NetworkScheduler
...
import net.waloyodev.speedbrowser5g.extensions.color
import net.waloyodev.speedbrowser5g.extensions.drawable
import net.waloyodev.speedbrowser5g.favicon.FaviconModel
...
import net.waloyodev.speedbrowser5g.utils.ThemeUtils
