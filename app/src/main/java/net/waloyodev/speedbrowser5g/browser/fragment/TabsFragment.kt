...
import net.waloyodev.speedbrowser5g.browser.TabsView
import net.waloyodev.speedbrowser5g.browser.fragment.anim.HorizontalItemAnimator
import net.waloyodev.speedbrowser5g.browser.fragment.anim.VerticalItemAnimator
...
import net.waloyodev.speedbrowser5g.extensions.desaturate
import net.waloyodev.speedbrowser5g.extensions.drawTrapezoid
import net.waloyodev.speedbrowser5g.preference.UserPreferences
import net.waloyodev.speedbrowser5g.utils.DrawableUtils
import net.waloyodev.speedbrowser5g.utils.ThemeUtils
import net.waloyodev.speedbrowser5g.utils.Utils
import net.waloyodev.speedbrowser5g.view.BackgroundDrawable
 ...
 * BrowserController in order to get the current UI state of the waloyodev. It also uses the
...
class TabsFragment : Fragment(), View.OnClickListener, View.OnLongClickListener, TabsView {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val tipeiklan = prefs.getInt("tipeiklan", 0)
        if (tipeiklan == 0) {
