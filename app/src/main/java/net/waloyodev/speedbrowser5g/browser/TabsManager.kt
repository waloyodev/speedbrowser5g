...
import net.waloyodev.speedbrowser5g.di.DiskScheduler
...
import net.waloyodev.speedbrowser5g.utils.FileUtils
import net.waloyodev.speedbrowser5g.utils.Option
import net.waloyodev.speedbrowser5g.utils.UrlUtils
import net.waloyodev.speedbrowser5g.utils.value
...
class TabsManager @Inject constructor(
    ...
    /**
     * Initialize the state of the [TabsManager] based on previous state of the waloyodev and with the
    ...
    /**
     * Method used to resume all the tabs in the waloyodev. This is necessary because we cannot pause
    ...
    /**
     * Method used to pause all the tabs in the waloyodev. This is necessary because we cannot pause
     * the WebView when the application is open currently due to a bug in the WebView, where calling
     * onResume doesn't consistently resume it.
     */
    fun pauseAll() {
