...
package net.waloyodev.speedbrowser5g.browser.activity

import net.waloyodev.speedbrowser5g.IncognitoActivity
import net.waloyodev.speedbrowser5g.R
import net.waloyodev.speedbrowser5g.browser.*
...
import net.waloyodev.speedbrowser5g.constant.LOAD_READING_URL
import net.waloyodev.speedbrowser5g.controller.UIController
import net.waloyodev.speedbrowser5g.database.Bookmark
import net.waloyodev.speedbrowser5g.database.HistoryEntry
...
import net.waloyodev.speedbrowser5g.di.DatabaseScheduler
import net.waloyodev.speedbrowser5g.di.MainHandler
import net.waloyodev.speedbrowser5g.di.MainScheduler
import net.waloyodev.speedbrowser5g.di.injector
import net.waloyodev.speedbrowser5g.dialog.BrowserDialog
import net.waloyodev.speedbrowser5g.dialog.DialogItem
import net.waloyodev.speedbrowser5g.dialog.LightningDialogBuilder
import net.waloyodev.speedbrowser5g.extensions.*
import net.waloyodev.speedbrowser5g.html.bookmark.BookmarkPageFactory
import net.waloyodev.speedbrowser5g.html.history.HistoryPageFactory
import net.waloyodev.speedbrowser5g.html.homepage.HomePageFactory
import net.waloyodev.speedbrowser5g.interpolator.BezierDecelerateInterpolator
import net.waloyodev.speedbrowser5g.log.Logger
import net.waloyodev.speedbrowser5g.notifications.IncognitoNotification
...
import net.waloyodev.speedbrowser5g.ssl.SSLState
import net.waloyodev.speedbrowser5g.utils.*
import net.waloyodev.speedbrowser5g.view.*
import net.waloyodev.speedbrowser5g.view.SearchView
import net.waloyodev.speedbrowser5g.view.find.FindResults
...
abstract class BrowserActivity : ThemableBrowserActivity(), BrowserView, UIController, OnClickListener {
    ...
    /**
     * Determines if the current waloyodev instance is in incognito mode or not.
     */
    ...
    /**
     * Choose what to do when the waloyodev visits a website.
     *
    ...
    protected fun panicClean() {
        logger.log(TAG, "Closing waloyodev")
    ...
    override fun setTabView(view: View) {
        ...
        //     @Override
        //     public void run() {
        // Remove waloyodev frame background to reduce overdraw
    ...
    /**
     * function that opens the HTML history page in the waloyodev
     */
    ...
    /**
     * used to allow uploading into the waloyodev
     */
