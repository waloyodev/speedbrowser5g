package net.waloyodev.speedbrowser5g.preference

import net.waloyodev.speedbrowser5g.constant.DEFAULT_ENCODING
import net.waloyodev.speedbrowser5g.constant.NO_PROXY
import net.waloyodev.speedbrowser5g.constant.SCHEME_HOMEPAGE
import net.waloyodev.speedbrowser5g.device.ScreenSize
import net.waloyodev.speedbrowser5g.di.UserPrefs
import net.waloyodev.speedbrowser5g.preference.delegates.booleanPreference
import net.waloyodev.speedbrowser5g.preference.delegates.intPreference
import net.waloyodev.speedbrowser5g.preference.delegates.stringPreference
import net.waloyodev.speedbrowser5g.search.engine.GoogleSearch
