 ...
 */
package net.waloyodev.speedbrowser5g.utils;
...
public final class Utils {
     ...
     * waloyodev. The icon, URL, and title are used in
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            if (shortcutManager.isRequestPinShortcutSupported()) {
                ShortcutInfo pinShortcutInfo =
                    new ShortcutInfo.Builder(activity, "waloyodev-shortcut-" + historyEntry.getUrl().hashCode())
