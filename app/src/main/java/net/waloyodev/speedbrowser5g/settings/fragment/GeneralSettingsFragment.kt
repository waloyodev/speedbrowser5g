...
import net.waloyodev.speedbrowser5g.constant.*
...
import net.waloyodev.speedbrowser5g.search.engine.BaseSearchEngine
import net.waloyodev.speedbrowser5g.search.engine.CustomSearch
