...
import net.waloyodev.speedbrowser5g.constant.TEXT_ENCODINGS
...
class AdvancedSettingsFragment : AbstractSettingsFragment() {
    ...
    /**
     * Shows the dialog which allows the user to choose the waloyodev's rendering method.
     *
    ...
    /**
     * Shows the dialog which allows the user to choose the waloyodev's text encoding.
     *
     * @param summaryUpdater the command which allows the summary to be updated.
     */
    ...
    /**
     * Shows the dialog which allows the user to choose the waloyodev's URL box display options.
     *
     * @param summaryUpdater the command which allows the summary to be updated.
     */
