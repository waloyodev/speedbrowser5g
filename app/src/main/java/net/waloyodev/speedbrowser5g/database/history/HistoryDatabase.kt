 ...
 */
package net.waloyodev.speedbrowser5g.database.history

import net.waloyodev.speedbrowser5g.database.HistoryEntry
import net.waloyodev.speedbrowser5g.database.databaseDelegate
import net.waloyodev.speedbrowser5g.extensions.firstOrNullMap
import net.waloyodev.speedbrowser5g.extensions.useMap
