 ...
 */
package net.waloyodev.speedbrowser5g.controller

import net.waloyodev.speedbrowser5g.browser.TabsManager
...
/**
 * The monolithic controller that routes events between views in the waloyodev.
 */
interface UIController {
    ...
    /**
     * Notify the waloyodev that the website currently being displayed by the [tab] wants to be
     * closed.
     */
    ...
    /**
     * Show the close waloyodev dialog for the tab at [position].
     */
    fun showCloseDialog(position: Int)

    /**
     * Notify the waloyodev that the new tab button was clicked.
     */
    fun newTabButtonClicked()

    /**
     * Notify the waloyodev that the new tab button was long pressed by the user.
     */
    fun newTabButtonLongClicked()

    /**
     * Notify the waloyodev that the tab close button was clicked for the tab at [position].
     */
    fun tabCloseClicked(position: Int)

    /**
     * Notify the waloyodev that the tab at [position] was selected by the user for display.
     */
    fun tabClicked(position: Int)

    /**
     * Notify the waloyodev that the user pressed the bookmark button.
     */
    fun bookmarkButtonClicked()

    /**
     * Notify the waloyodev that the user clicked on the bookmark [entry].
     */
    ...
    /**
     * Notify the waloyodev that the user pressed the back button.
     */
    fun onBackButtonPressed()

    /**
     * Notify the waloyodev that the user pressed the forward button.
     */
    fun onForwardButtonPressed()

    /**
     * Notify the waloyodev that the user pressed the home (not device home) button.
     */
    fun onHomeButtonPressed()

    /**
     * Notify the waloyodev that the bookmarks list has changed.
     */
    fun handleBookmarksChange()

    /**
     * Notify the waloyodev that the provided bookmark [bookmark] has changed.
     */
    fun handleBookmarkDeleted(bookmark: Bookmark)

    /**
     * Notify the waloyodev that the download list has changed.
     */
    fun handleDownloadDeleted()

    /**
     * Notify the waloyodev that the history list has changed.
     */
