 ...
 */
package net.waloyodev.speedbrowser5g.download;
...
import net.waloyodev.speedbrowser5g.MainActivity;
import net.waloyodev.speedbrowser5g.R;
import net.waloyodev.speedbrowser5g.constant.Constants;
import net.waloyodev.speedbrowser5g.controller.UIController;
import net.waloyodev.speedbrowser5g.database.downloads.DownloadEntry;
...
import net.waloyodev.speedbrowser5g.extensions.ActivityExtensions;
