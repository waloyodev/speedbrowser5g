package net.waloyodev.speedbrowser5g.adblock

import net.waloyodev.speedbrowser5g.di.DiskScheduler
import net.waloyodev.speedbrowser5g.extensions.inlineReplace
import net.waloyodev.speedbrowser5g.extensions.inlineTrim
import net.waloyodev.speedbrowser5g.extensions.stringEquals
import net.waloyodev.speedbrowser5g.extensions.substringToBuilder
